...
@section('content')
    <div class="version-history">
        ...
        <h3>{{ config('app.name') }} Beta <small>Release Date: 12/12/17</small></h3>
        <strong>New Features:</strong>
        <ol>
